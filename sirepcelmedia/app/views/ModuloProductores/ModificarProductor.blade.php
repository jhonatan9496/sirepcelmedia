...
{{ $alert }}
    ...
    <br>
     ...
     <div id="contenedorResponsive">  
        ...
        {{ Form::open(array('action' => 'ProductorController@actualizarproductor', 'method' => 'GET','class'=>'cadenagrupo'), array('role' => 'form')) }}
            {{ Form::text('id', $productorActualizar->id, array('readonly'=>'nonreadonlye')) }}
            ...
            <div id="cajas" align="left">
               ...
               <div id="entradaTexto">
                    ...
                    <br>
                    {{ Form::text('primer_nombre',$productorActualizar->primer_nombre , array('required'),array('value'=>'prueba')) }}
               </div>
               <div id="entradaTexto">
                    <label>Segundo Nombre</label>
                    <br>
                    {{ Form::text('segundo_nombre', $productorActualizar->segundo_nombre, array('placeholder' => 'Introduce Nombre')) }}
               </div>
               <div id="entradaTexto">
                    <label>Primer Apellido</label>
                    <br>
                    {{ Form::text('primer_apellido', $productorActualizar->primer_apellido, array('placeholder' => 'Introduce apellido','required')) }}
               </div>
               <div id="entradaTexto">
                    <label>Segundo Apellido</label>
                    <br>
                    {{ Form::text('segundo_apellido', $productorActualizar->segundo_apellido, array('placeholder' => 'Introduce apellido','required')) }}
               </div>
               <div id="entradaTexto">
                    <label>Cédula</label>
                    <br>
                    {{ Form::text('cedula', $productorActualizar->cedula, array('placeholder' => 'Introduce Nombre','required')) }}
               </div>
               <div id="entradaTexto">
                    <label>Email</label>
                    <br>
                    {{ Form::text('correo', $productorActualizar->correo, array('placeholder' => 'Introduce Nombre','required')) }}
               </div>
               
               <div id="entradaTexto">
                    <label>Profesion</label>
                    <br>
                    {{ Form::text('profesion', $productorActualizar->profesion, array('placeholder' => 'Introduce profesion','required')) }}
               </div>
               <div id="entradaTexto">
               ...
               <div id="entradaTexto">
                    <label>Celular</label>
                    <br>
                    {{ Form::text('celular', $productorActualizar->celular, array('placeholder' => 'Introduce celular','required')) }}
               </div>
               ...
               <div id="entradaTexto">
                ...
                <br>
                    {{ Form::text('fecha_inscripcion', $productorActualizar->fecha_inscripcion, array('type' => 'date','required')) }}
               </div>
                <br>
    		</div>
            <br>
    		...
    		<div id="cajas" align="left">
                ...
                <div id="entradaTexto">
                    ...
                    {{ Form::text('vereda', $productorActualizar->vereda, array('placeholder' => 'Introduce vereda','required')) }}
                ...
                <div id="entradaTexto">
                   <label>Finca</label>
                   <br>
                    {{ Form::text('finca', $productorActualizar->finca, array('placeholder' => 'Introduce finca','required')) }}
                </div>
    	    </div>
            <br>
           ...
           <!-- Botones -->
           <div align="center">
            {{ Form::button('Actualizar Productor', array('type' => 'submit', 'class' => 'boton')) }} 
           <button class="boton">Limpiar Formulario</button>
           <button class="boton">Mensajes Enviados</button>
            </div>
